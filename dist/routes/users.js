...
var excludePassword = require('../utils/users').excludePassword;
router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var users_1, user, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                users_1 = _a.sent();
                for (user in users_1) {
                    excludePassword(users_1[user], 'password');
...
router.post('/:username', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var username, bio, updatedBio, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                username = req.params.username;
